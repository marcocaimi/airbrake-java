...
import airbrake.logback.AirbrakeAppender.Notify;
...
public class AirbrakeAppenderTest {
    ...
    AirbrakeAppender appender;

    Logger logger;

    ArgumentCaptor<AirbrakeNotice> captor;

    public AirbrakeAppenderTest() {
        ...
        appender = new AirbrakeAppender(notifier);
    ...
    public void testWithException() {
       ...
       // Assertions.assertThat(notice.errorMessage()).isEqualTo(exception.getMessage());
        ...
        //Assertions.assertThat(topTraceLine).startsWith("at net.anthavio.airbrake.AirbrakeAppenderTest.testWithException");
...
//        String topTraceLine = notice.backtrace().iterator().next();
//        Assertions.assertThat(topTraceLine).startsWith("at net.anthavio.airbrake.AirbrakeAppenderTest.testSimpleMessage");
